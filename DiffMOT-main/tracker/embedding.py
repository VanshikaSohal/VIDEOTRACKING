...
class EmbeddingComputer:
    def __init__(self, config, dataset, test_dataset, grid_off, max_batch=1024):
        ...
        self.reid_dir = getattr(config, "reid_dir", "external/reid_cache")
        os.makedirs(self.reid_dir, exist_ok=True)

        self.cache_path = os.path.join(self.reid_dir, "{}_embedding.pkl")
        self.cache = {}
        self.cache_name = ""
    ...
    def initialize_model(self):
        ...
        print("[ReID] model loaded from:", path)
